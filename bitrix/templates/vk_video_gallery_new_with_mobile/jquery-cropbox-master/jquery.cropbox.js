  ...
  function factory($) {
    ...
    Crop.prototype = {
      ...
      updateOptions: function () {
        var self = this;
        self.img_top = this.options.img_top;
        self.img_left = this.options.img_left;
      ...
      setCrop: function (result) {
        ...
        this.img_width = (this.options.img_width)? this.options.img_width : Math.ceil(this.width*this.percent);
        this.img_height = (this.options.img_height)? this.options.img_height : Math.ceil(this.height*this.percent);
        self.img_top = this.options.img_top;
        self.img_left = this.options.img_left;
        this.$image.css({ width: this.img_width, left: this.img_left, top: this.img_top, height: this.img_height});
        this.update();
      },
