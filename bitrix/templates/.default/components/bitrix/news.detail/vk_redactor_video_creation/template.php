...
$title=urlencode(GetMessage("S_TITLE")."Сохраняйте и дарите яркие воспоминания! Бесплатно:)");
...
$image=urlencode('http://fromfoto.com/images/logo41.jpg');
	...
	*/?>
    <div class="hide_after_order" style="display:none">
    	<div id="text_before_submit_free">
    		<br /><p class="hh1" style="padding:9px 20px 0px;"><?=GetMessage("S_TITLE_1")?></p>
    		<p><?=GetMessage("S_TITLE_2")?></p>
			<div class="soc_s" style="padding-bottom: 20px; padding-top: 25px;">
				<a href="#" onclick="yaCounter25315490.reachGoal('repost1');" class="a_order_clip_btn_vk btn_go" style="font-size: 12px; height: 38px; padding: 11px; width: 270px;">СДЕЛАТЬ РЕПОСТ</a>
