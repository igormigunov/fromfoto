...
<div class="container" <? if($arResult['PROPERTIES']['FREE_PERIOD']['VALUE']): ?> style="display:none" <?else:?> style="margin-top: 20px;" <? endif; ?>>
	...
	<div class="bottom_text" style="border: none;">
       	<? if($arResult['PROPERTIES']['FREE_PERIOD']['VALUE']): ?>
	    	<?=GetMessage("S_DO_FREE2")?>
       	<? else: ?>
	    	<?=GetMessage("S_DO_FREE")?>
        <? endif; ?>
    </div>
...
$image=urlencode('http://fromfoto.com/images/logo17.jpg');
	...
	*/?>
    <div class="hide_after_order" style="display:none">
    	<div id="text_before_submit_free">
			...
			<div class="soc_s" style="padding-top: 14px;">
				<a href="#" class="a_order_clip_btn_vk btn_go" style="height: 98px; width:98px; padding: 7px;"></a>
    ...
    <style>
		...
		.soc_s .a_order_clip_btn_vk.btn_go{
			background: url(/images/1vk.png) no-repeat ;
		}
    	.soc_s .a_order_clip_btn_vk.btn_go:hover{
			background: url(/images/1vk_hover.png) no-repeat ;
		}
