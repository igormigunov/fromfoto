...
$summary=urlencode(prepare_row('Онлайн сервис для создания клипов и слайд-шоу из фотографий FromFoto.com. Попробуй БЕСПЛАТНО!')); 
$image=urlencode('http://fromfoto.com/images/logo5.jpg');
...
<div class="popup" style="display: none;">
	<div class="popup-container with_border" style="margin: -160px auto 0; top: 50%;">
		...
		<? else: ?>
		<a href="#" style="text-decoration: uppercase; margin-bottom: 10px; width: 256px;" class="button-slide under-content-title repost_clip_vk">сделать репост</a>
		<? endif; ?>
