...
<?
	...
	$en_land = (SITE_ID == 'en')?'en_':'';

	$land = (SITE_ID == 'en')?'en':'ru';
...
<? if(!$arResult['PROPERTIES']['VIDEO']['VALUE']):?>
	...
	<? $APPLICATION->IncludeFile(
		...
		$APPLICATION->GetTemplatePath("include_areas/".$en_land."no_video.php"),
...
?>    
        ...
        <p class="text-done">Скачать свой клип в HD-качестве без подписи "Образец" Вы сможете любым удобным для Вас способом, оплатив <?=$out_summ?> р.</p>
        <? if($ar_clip['PROPERTY_FREE_PRICE_VALUE']): ?>
