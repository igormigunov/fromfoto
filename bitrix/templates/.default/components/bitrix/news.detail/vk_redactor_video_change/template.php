...
<div id="vim">
	<iframe frameborder="0" src="<?=preg_replace("/youtu\.be/", 'www.youtube.com/embed', $clip['PROPERTY_YOUTUBE_VALUE']); ?>?rel=0&amp;loop=1&amp;modestbranding=1&amp;showinfo=0&amp;controls=0" allowfullscreen="" ></iframe>
</div>
<? endif;?>
                ...
                <table role="presentation" class="table table-striped"><tbody class="files">
					...
					<? foreach($photo as $ph): ?>
						...
						<?
							...
							copy($dir.$num.'_.png', $uploaddir.$num.'_.png');
						...
						<div class="img_prev_upl in" style="opacity: 1 !important;">
							<span class="preview">            	
								...
								<img src="<?=$path_to_dir.$num.'_.png';?>" uniq_name="<?=$num.'_.png';?>" file_name="<?=$num.'_.png';?>" real_height="<?=$h_i ? $h_i : "720"?>" real_width="<?=$w_i ? $w_i : "1280"?>" id="img_n-<?=$photo_n; ?>" href="<?=$path_to_dir.trim($contents_img[$photo_n]);?>">
							</span>
						</div>
					<? endforeach;?>
				</tbody></table>
