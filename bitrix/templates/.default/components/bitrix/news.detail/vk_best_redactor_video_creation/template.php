...
<? if($arResult['PROPERTIES']['PREV_VIMEO2']['VALUE']):?>
<div id="vim">
                ...
                <div class="fileupload-buttonbar">
                    <div class="my-container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 button-create"><i class="fa fa-camera fa-2x"></i><span class="btn btn-success fileinput-button silver_btn btn-primary">
                                    <span><?=GetMessage("S_ADD_FILES")?></span>
                                    <input type="file" name="files[]" multiple>
                                </span>
                            </div>
                            <div style="text-align: left;" class="col-xs-4 button-create"><i class="fa fa-trash-o fa-2x"></i><button type="button" class="btn btn-danger delete silver_btn btn-primary">
                                <span><?=GetMessage("S_DELETE_IMG")?></span>
                                </button>
                            </div>
                            <div class="col-xs-2"></div>
                        </div>
    ...
    <div class="container step_2_station hide_after_order my-indent">
        ...
        <div>
			...
			<? endif; ?>
            	...
            	<textarea <? if($v['PROPERTY_SIGN_VALUE']):?> placeholder="<?=$v['PROPERTY_SIGN_VALUE']; ?>"<? endif; ?> class="text_inp text_show_<?=$k;?>" size_value="<?=$v['PROPERTY_COUNT_SYMBOLS_VALUE']; ?>" ><?=substr($arTexts[$k], 0, intval($v['PROPERTY_COUNT_SYMBOLS_VALUE']));?></textarea>
                </div>
    ...
    <div class="container step_2_station hide_after_order my-indent">
        <div class="row">
        	...
        	<div class="col-xs-5">
            	...
            	<input id="email_vk" type="email" placeholder="Ваш E-mail" class="vk_input" value="<?=$cookie_login;?>">
            </div>

            <div <? if($arResult['PROPERTIES']['FREE_PERIOD']['VALUE']): ?> style="display:none"<? endif; ?>> </div> 
        </div>
    </div>

    
<div class="container" <? if($arResult['PROPERTIES']['FREE_PERIOD']['VALUE']): ?> style="display:none" <?else:?> style="margin-top: 20px;" <? endif; ?>>
	...
	<div class="bottom_text" style="border: none;">
		<?=GetMessage("S_READY_TITLE")?>
    </div>
                            ...
                            <div style="text-align:center;padding-top: 27px; margin-bottom: 40px;">
                                ...
                                <input type="button" id="best_order_clip_btn" style="display:none;" value="send_clip">
                            </div>
                            <? endif; ?>
                        </form>
...
$title=urlencode(GetMessage("S_TITLE")." Моё видео здесь: http://fromfoto.com/fljvrFG/");
...
$image=urlencode('http://fromfoto.com/images/logo12.jpg');
	...
	*/?>
    <div class="hide_after_order" style="display:none">
    	<div id="text_before_submit_free">
    		<p class="hh1"><?=GetMessage("S_TITLE_1")?></h2>
    		<p><?=GetMessage("S_TITLE_2")?></p>
			<div class="soc_s" style="padding-top: 20px;">
				<a href="#" class="a_order_clip_btn_vk btn_go" style="height: 43px; padding: 7px;">получить ссылку</a>
			...
			<br/>
			<br/>
    		<p style="width: 90%; margin: auto; font-size: 18px;"><?=GetMessage("S_TITLE_3")?></p>
    ...
    <script>
		...
		$('.a_order_clip_btn_vk').click(function(e){
			...
			//window.open('https://vk.com/share.php?url=<?php echo $url; ?>','sharer','toolbar=0,status=0,width=548,height=325');
			$('#cboxClose').trigger('click');
		});
