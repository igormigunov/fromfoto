...
?>
		<div id="preview_popup_first_select" class="preview_popup" style="background:url(/images/bagr_new_hall.png); width:1090px; height:707px;" >
			<div class='back_close_popup'><img src='/images/back_close_popup.png' border='0' /></div>
		...
		<div id="preview_popup_final_user" class="preview_popup" >
			...
			<div class='gr_pp'>
				...
				<tr>
					<td class='left_side btn_ord'>
						<a href="#menu-choose" style='padding-top:13px' id="people_free_btn"><?=GetMessage("S_SAM")?></a>
					</td>
					<td>
					</td>
					<td class='right_side btn_ord'>
						<a href="#menu-feedback" style='padding-top:13px' class="right_btn" id="for_me"><?=GetMessage("S_FOR_ME")?></a>
					</td>
				</tr>
				</table>
			</div>
...
<style>
	.preview_popup .prev_name{
		font-family:'Tauruslight', 'Arial', sans-serif;
		font-weight:bold;
	}
