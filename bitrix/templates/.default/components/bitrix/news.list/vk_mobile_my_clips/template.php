...
$url1=urlencode('http://fromfoto.com/123/');
$urlok1=urlencode('http://fromfoto.com/123/');
...
<div class="small-text"><?=GetMessage("S_CHECK_SPAM");?></div>
...
<div class="popup" style="display: none;">
	<div class="popup-container with_border" style="margin: -160px auto 0; top: 50%;">
		...
		<a onclick="yaCounter25315490.reachGoal('repost3');" class="button-slide under-content-title a_order_clip_btn_vk" href="#">РАССКАЗАТЬ ДРУЗЬЯМ</a>
