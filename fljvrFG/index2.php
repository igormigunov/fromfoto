...
<? global $USER; ?>
<? if(!$USER->IsAuthorized() || !$_REQUEST['check'] || !$_SERVER['HTTP_REFERER']):?>

<div id="preview_popup_full" class="no_hide_after_order"></div>
<div id="preview_popup" class="no_hide_after_order">
	<div id="auth_social" class="preview_popup" style="background-image:none; background:#fff; border: 2px solid #5d7395; border-radius: 0;" >
		<div class="text_popup" id="text_popup1">
			<?$APPLICATION->IncludeComponent("bitrix:system.auth.form","vk_fromfoto",Array(
...
<style>
	...
	.preview_popup #text_popup1.text_popup{
		width: 750px !important;
		height: 620px !important;
	}
