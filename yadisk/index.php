...
class Config{
	...
	function __construct()
 	{
		$this->data['oauth_app_id'] = '77da79949b934acda3c3bb52adfc0da8';
		$this->data['oauth_token_url'] = 'https://oauth.yandex.ru/token';
		$this->data['oauth_referer_url'] = 'http://video_gallery/';
		$this->data['oauth_app_secret'] = '71cffe417dcb45b1991b68c4b7a03729';
		$this->data['oauth_login'] = 'tanyush-x';
		$this->data['oauth_password'] = '123biytt$$';
...
$YaDisk->mkdir('/tes/');
$YaDisk->upload('/yadisk/monitor-multipage.png','/tes/monitor-multipage.png');
$YaDisk->download('/tes/monitor-multipage.png','/yadisk/monitor-multipage1.png');
?>
