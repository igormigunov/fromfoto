...
<div align="center"> 	 
  <br />
 	<span style="font-size: 17px; color: rgb(93, 115, 149); font-weight: bold; text-transform: uppercase;">Выберите шаблон для своего клипа</span> 
  <br />
<span style="font-size: 15px; color: rgb(2, 2, 2); padding: 15px;">Ускоренное изготовление!</span></div>
 <?
