...
<div align="center"><font size="4">Выберите шаблон, загрузите свои фото и получите готовое слайд-шоу.  </font></div>
 
<div align="center"><font size="4">Можно добавлять свою музыку и текст.</font> 
  <br />
 </div>
 <?
...
<div class="block-content works-wrapper" id="menu-choose"> 
  <div class="works block-padding fullwidth"> <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FILTER_NAME" => "",
		"FIELD_CODE" => "",
		"PROPERTY_CODE" => array("FREE_PERIOD","WE_DO","PREV_VIMEO"),
		"CHECK_DATES" => "Y",
		"DETAIL_URL" => "",
